                ...
                <section id="assetStep3Section" class="wizard-step hidden">
                    <div class="wizard-form asset-step-card">
                        <div class="wizard-form__scroll">
                            <div class="wizard-form__content">
                                ...
                                <div class="asset-step-grid asset-step-grid--details">
                                    ...
                                    <label class="form-group asset-form-group asset-edit-serial-field hidden">
                        ...
                        <div class="asset-step-card__actions">
                            ...
                            <button type="button" id="assetDeleteBatchButton" class="asset-step-btn asset-step-btn--danger hidden">`r`n                                <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 6h18M8 6v12a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V6m-3 0V4a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v2M10 11v6M14 11v6"></path></svg>`r`n                                <span>Delete Batch</span>`r`n                            </button>`r`n                            <button id="assetSubmitButton" type="submit" class="asset-step-btn asset-step-btn--primary asset-step-btn--compact">
