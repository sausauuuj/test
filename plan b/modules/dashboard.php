...
<section id="dashboard" class="app-view active" data-view="dashboard">
    <div class="view-scroll section-stack">
        <div class="section-head">
            ...
            <p class="section-copy">Inventory overview &amp; summary</p>
        </div>
        ...
        <div class="dashboard-metric-grid">
            ...
            <article class="dashboard-metric dashboard-metric--delay-4">
                ...
                <div class="dashboard-metric__content">
                    <p class="dashboard-metric__label">Semi-Expendable</p>
        ...
        <div class="dashboard-chart-grid">
            <article class="panel-card chart-card dashboard-chart-card dashboard-chart-card--delay-1">
            ...
            <article class="panel-card chart-card dashboard-chart-card dashboard-chart-card--delay-2">
