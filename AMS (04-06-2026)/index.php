        ...
        <div class="w-full max-w-2xl rounded-[1.2rem] bg-white p-6 shadow-2xl">
            ...
            <form id="editAssetForm" class="mt-6 space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <label class="form-group"><span class="form-label">Property Type</span><select name="property_type" class="form-input"><option value="">Select type</option></select><span class="field-error hidden" data-error-for="property_type"></span></label>
                    ...
                    <label class="form-group"><span class="form-label">Division</span><select name="division" class="form-input"><option value="">Select division</option></select><span class="field-error hidden" data-error-for="division"></span></label>

                    <label class="form-group"><span class="form-label">Officer</span><select name="officer_id" class="form-input"><option value="">Select officer</option></select><span class="field-error hidden" data-error-for="officer_id"></span></label>
                </div>
