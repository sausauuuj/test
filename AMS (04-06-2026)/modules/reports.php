...
<section id="reports" class="app-view" data-view="reports">
    <div class="view-scroll section-stack">
        ...
        <div id="reportWorkflowArea" class="report-workspace hidden">
                        ...
                        <form id="reportForm" class="mt-4 space-y-4">
                            ...
                            <div class="report-action-bar">
                                ...
                                <div class="report-action-group">
                                    <button id="printReport" type="button" class="action-secondary action-excel action-excel--icon" aria-label="Print PAR Report" title="Print PAR Report" disabled>
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
            ...
            <article id="spiReportPanel" class="panel-card hidden">
                <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        <p class="panel-eyebrow">SPI Workflow</p>
                        <h3 class="panel-title">SPI Report Generation</h3>
                    </div>
                </div>

                <div class="mt-5 space-y-4">
                    <div class="form-block report-step">
                        <p class="form-block__label report-step__title">Step 1: Set Filters</p>
                        <div class="mt-4 grid gap-4 lg:grid-cols-3">
                            <label class="form-group">
                                <span class="form-label">Classification</span>
                                <select id="spiClassification" class="form-input">
                                    <option value="">Select Classification</option>
                                    <option value="PPE">PPE (Physical Count - RPCPPE)</option>
                                    <option value="SEMI">SEMI (Registry - RegSPI)</option>
                                </select>
                            </label>
                            <label class="form-group">
                                <span class="form-label">Funding Source</span>
                                <select id="spiFundingSource" class="form-input">
                                    <option value="">All Sources</option>
                                    <?php foreach ($fundingSources as $source): ?>
                                        <option value="<?= escape_html($source); ?>"><?= escape_html($source); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </label>
                        </div>
                        <div class="mt-4 grid gap-4 lg:grid-cols-3">
                            <label class="form-group">
                                ...
                                <select id="spiAssetType" class="form-input">
                            ...
                            <label class="form-group">
                                <span class="form-label">Date From (MM/DD/YY)</span>
                                <input type="date" id="spiDateFrom" class="form-input" placeholder="MM/DD/YY">
                            </label>
                            <label class="form-group">
                                <span class="form-label">Date To (MM/DD/YY)</span>
                                <input type="date" id="spiDateTo" class="form-input" placeholder="MM/DD/YY">
                            </label>
                        </div>
                    </div>

                    <div class="form-block report-step">
                        <p class="form-block__label report-step__title">Step 2: Generate Report</p>
                        <form id="spiReportForm" class="mt-4 space-y-4">
                            <input type="hidden" id="spiReportTypeField" name="report_type" value="RPCPPE">
                            <div class="report-action-bar">
                                <button type="submit" class="action-primary">Generate SPI Report</button>
                                <div class="report-action-group">
                                    <button id="spiPrintReport" type="button" class="action-secondary action-excel action-excel--icon" aria-label="Print SPI Report" title="Print SPI Report" disabled>
                                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round">
                                            <path d="M7 9V4.5h10V9"></path>
                                            <path d="M6.5 18H5a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-1.5"></path>
                                            <path d="M7 14h10v5.5H7z"></path>
