...
<th class="px-4 py-3 font-medium text-right registration-table__heading registration-table__heading--actions">Action</th>
                            </tr>
                        </thead>
                ...
                <div class="table-pagination">
                    <div class="pagination-info">
                        <label class="pagination-rows-label">
                            Show
                            <input type="number" id="registrationRowsPerPage" class="pagination-rows-input" value="10" min="1" max="500">
                            records
                        </label>
                    </div>
...
<div id="officerDetailsModal" class="fixed inset-0 z-[1000] hidden items-center justify-center bg-slate-950/55 p-4 backdrop-blur-sm">
    <div class="registration-modal-shell officer-details-shell">
        <div class="registration-modal__head">
            <div>
                <p class="panel-eyebrow">Accountable Officer</p>
                <h3 id="officerDetailsName" class="panel-title">Officer</h3>
                <p id="officerDetailsMeta" class="registration-modal__copy officer-details-meta"></p>
            </div>
        ...
        <div class="registration-modal__body">
            <div id="officerDetailsContent" class="detail-grid detail-grid--officer"></div>
        </div>
        <div class="asset-step-card__actions asset-step-card__actions--end registration-modal__actions">
