...
<div id="officerRegistrationModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-slate-950/55 p-4 backdrop-blur-sm">
    <div class="registration-modal-shell">
        <div class="registration-modal__head">
            <div>
                <p class="panel-eyebrow">Accountable Officer</p>
                <h3 id="officerModalTitle" class="panel-title">Register Officer</h3>
                <p id="officerModalCopy" class="registration-modal__copy">Choose a division card first, then complete the officer profile.</p>
            </div>
            <button id="closeOfficerRegistration" type="button" class="asset-entry-close" aria-label="Close officer registration">
...
<div id="officerDetailsModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-slate-950/55 p-4 backdrop-blur-sm">
